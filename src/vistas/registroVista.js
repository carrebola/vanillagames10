...
export default {
  ...
  <div class="m-5 mx-auto" style="max-width: 400px">
    ...
    <form id="formularioRegistro" class="form border shadow-sm p-3" novalidate>
      ...
      <input required id="pass" type="password" class="form-control" name="password" />
    ...
    formulario.addEventListener('submit', async (event) => {
      ...
      if (!formulario.checkValidity()) {
        ...
        try {
          ...
          const perfilCreado = await Perfil.create(perfil)
          console.log('Pefil Creado', perfilCreado)
